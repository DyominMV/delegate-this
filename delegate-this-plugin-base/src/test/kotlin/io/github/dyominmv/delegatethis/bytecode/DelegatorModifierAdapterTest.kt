...
import io.github.dyominmv.delegatethis.AlreadyModified
import io.github.dyominmv.delegatethis.NonDelegatingConstructorMarker
import io.github.dyominmv.delegatethis.DelegateThis
import io.github.dyominmv.delegatethis.samples.NameExtractorDelegate
import io.github.dyominmv.delegatethis.samples.SampleInterface
...
class DelegatorModifierAdapterTest {
    ...
    fun `ClassWithSimpleDelegate should be comparable`(): Unit = assertDoesNotThrow {
        val instance = Class.forName("io.github.dyominmv.delegatethis.samples.ClassWithSimpleDelegate")
    ...
    fun `ClassWithDeeperDelegate should have name`(): Unit = assertDoesNotThrow {
        val instance = Class.forName("io.github.dyominmv.delegatethis.samples.ClassWithDeeperDelegate")
    ...
    fun `sadly, but ClassWithTiedDelegates should throw exception as lateinit var is not initialized yet`() {
        assertThrows<InvocationTargetException> {
            Class.forName("io.github.dyominmv.delegatethis.samples.ClassWithTiedDelegates")
    ...
    private val sampleClassNames = listOf(
        "io.github.dyominmv.delegatethis.samples.ClassWithDeeperDelegate",
        "io.github.dyominmv.delegatethis.samples.ClassWithSimpleDelegate",
        "io.github.dyominmv.delegatethis.samples.ClassWithTiedDelegates",
    )
